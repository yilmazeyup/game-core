...
import { Heart, Shield, Users, Rocket, Zap, Trophy } from "lucide-react";
      ...
      <section className="py-20 bg-gray-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400">A professional team driven by a passion for gaming</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {team.map((member, i) => (
              ...
              >
                <div
                  className={`aspect-square rounded-2xl bg-gradient-to-br ${member.gradient} mb-4 flex items-center justify-center`}
                >
